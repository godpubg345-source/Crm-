---
name: ved-gemini-skill-creator
description: Helper skill to create other Antigravity skills with correct structure and formatting. Use when the user asks to create a new skill or defines a new capability.
---
